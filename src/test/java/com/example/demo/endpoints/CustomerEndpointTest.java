...
public class CustomerEndpointTest {
	...
	@Test
	public void updateTests () throws JSONException {
		...
		for (Integer i : (List<Integer>)target.get("reservations")) {
			jsonArray.put(i);
		}

		JSONObject data = new JSONObject()
				.put("customerID", (int) target.get("customerID"))
				.put("username", target.get("username"))
				.put("email", "newEmail@ip.pl")
				.put("active", false)
				.put("reservations", jsonArray);
