...
public class ReservationEndpointTest {
	...
	public void init () {
		...
		reservations.add(req()
				...
				.statusCode(Matchers.is(200))
				.body("productID", Matchers.equalTo((int) productIDs.get(0).get("productID")))
				.body("customerID", Matchers.equalTo((int) customerIDs.get(0).get("customerID")))
		...
		reservations.add(req()
				...
				.statusCode(Matchers.is(200))
				.body("productID", Matchers.equalTo((int) productIDs.get(0).get("productID")))
				.body("customerID", Matchers.equalTo((int) customerIDs.get(1).get("customerID")))
	...
	public void deleteReservedTest () {
		...
		JsonPath t = req()
				...
				.put("/reservation").then()
				.statusCode(Matchers.is(200))
				.body("productID", Matchers.equalTo(pid))
				.body("customerID", Matchers.equalTo(cid))
...
//				.body("message", Matchers.equalTo("Invalid date"));
	...
	public void alredyReservedTests () {
		...
		req()
				...
				.put("/reservation").then()
				.statusCode(Matchers.is(200))
				.body("productID", Matchers.equalTo((int) product.get("productID")))
				.body("customerID", Matchers.equalTo((int) customer.get("customerID")))
